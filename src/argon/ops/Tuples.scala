...
trait TupleExp extends Staging with StructExp with NumExp with BitsExp {
  ...
  /** Direct methods **/
  def pack[A:Type,B:Type](a: A, b: B)(implicit ctx: SrcCtx): Tup2[A,B] = struct[Tup2[A,B]]("_1" -> a.s, "_2" -> b.s)
  def pack[A:Type,B:Type](t: (A, B))(implicit ctx: SrcCtx): Tup2[A,B] = struct[Tup2[A,B]]("_1" -> t._1.s, "_2" -> t._2.s)
  def unpack[A:Type,B:Type](t: Tup2[A,B])(implicit ctx: SrcCtx): (A,B) = (t._1, t._2)
  ...
  /** Type classes **/
  // --- Staged
  case class Tup2Type[A,B](m1: Type[A], m2: Type[B]) extends StructType[Tup2[A,B]] {
  ...
  implicit def tup2Type[A:Type,B:Type]: StructType[Tup2[A,B]] = Tup2Type(typ[A],typ[B])
  ...
  implicit def __tup2Bits[A:Type:Bits,B:Type:Bits]: Bits[Tup2[A,B]] = new Tup2Bits[A,B]
  ...
  implicit def __tup2Arith[A:Type:Arith,B:Type:Arith]: Arith[Tup2[A,B]] = new Tup2Arith[A,B]
}
