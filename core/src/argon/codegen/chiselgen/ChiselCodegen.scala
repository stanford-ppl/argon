...
trait ChiselCodegen extends Codegen with FileDependencies { // FileDependencies extends Codegen already
  ...
  override def copyDependencies(out: String): Unit = {
    ...
    dependencies ::= FileDep(resourcesPath, "app-level/regression_run.sh", "../", Some("regression_run.sh"))
    dependencies ::= FileDep(resourcesPath, "app-level/stats.sh", "../", Some("stats.sh"))
    ...
    dependencies ::= FileDep(resourcesPath, "app-level/regression_report.py", "../", Some("regression_report.py"))
